...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{use-cases-diag}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{auth-sequence-diag}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{add-event-sequence-diag}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{join-meet-sequence-diag}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{class-diag}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{studx-system-design}}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{caddyfile}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.55\linewidth]{whiteboard-upstream-demo}}
...
La figure \ref{fig:rust_syntax} est un extrait du code source de notre prototype \textbf{StudX}, qui présente la syntaxe du langage \textbf{Rust},  et montre l'intégration des divers outils suscités.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\linewidth]{rust-syntax}
