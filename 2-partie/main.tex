...
\begin{figure}[h]
  \centering
  \frame{\includegraphics[width=0.55\textwidth]{whiteboard-upstream-demo}}
...
Le tableau ci-dessous présente une liste non exhaustive des outils de développement employés pour la réalisation du prototype.
