...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\textwidth]{prototype/login}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/calendar-view}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/add-event-form}}
  \caption{Calendrier des planifications}
  \label{fig:add_event}
\end{figure}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/event-detail}}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.6\linewidth]{prototype/user-single-in-room}}
      \caption{Un participant}
  \end{subfigure}
  \vskip\baselineskip
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.6\linewidth]{prototype/user-with-participants-in-room}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.65\linewidth]{prototype/room-chat}}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.6\linewidth]{prototype/user-sharing-screen}}
      \caption{Participant faisant un partage d'écran.}
  \end{subfigure}
  \vskip\baselineskip
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.6\linewidth]{prototype/user-viewing-screen}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/whiteboard}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/wrritepad}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/participants}}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.525\linewidth]{prototype/confirm-exit}}
      \caption{Confirmation de déconnexion}
  \end{subfigure}
  \vskip\baselineskip
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.525\linewidth]{prototype/no-active-call}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/user-onboarding}}
...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=0.75\linewidth]{prototype/wip-dark-mode}}
  \caption{Mode sombre}
  \label{fig:dark_mode}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.6\linewidth]{prototype/settings}}
      \caption{Paramètres généraux.}
  \end{subfigure}
  \vskip\baselineskip
  \begin{subfigure}[b]{\textwidth}
      \centering
      \frame{\includegraphics[width=0.6\linewidth]{prototype/settings-end}}
